...
*   **实验设置**：
    ...
    *   **任务**：涵盖指令遵循 (IFEval)、通用知识 (MMLU) 和算术推理 (Countdown) 三种目标任务。
    *   **对比方法**：比较了三种方法：
...
*   **KL散度视角**：
    *   SFT 优化交叉熵损失，等价于最小化**正向KL散度** $$KL(π* \vert{}\vert{} π_θ)$$，具有“模式覆盖”特性。
    *   RL 优化KL正则化的奖励，等价于最小化**反向KL散度** $$KL(π_θ \vert{}\vert{} π*)$$，具有“模式寻求”特性。
